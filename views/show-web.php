		...
		<div class="s-body container">
			<div class="row">
				<div class="col-sm-12 col-md-9">
					<h1 class="h-title"> sản phẩm uy tín </h1>
					<ul class="nav-tabs nav nav-tabs">
						<li class="activee active"><a href="<?php echo getUrl('/') ?>"> TẤT CẢ SP</a></li>
						<?php foreach ($cate as $cate): ?>
						<li class=""><a href="detailcate?id=<?php echo $cate->id ?>"> <?php echo $cate->categaries_name ?> </a></li>
						<?php endforeach ?>
					</ul>
					<div class="tab-content">
						<div id="menu1" class="tab-pane fade in active">
							<div id="propagehome" class="row">
								...
								<div class="colsp col-xs-12 col-sm-6 col-md-4" id="pro-<?php echo $post->id ?>" >
									<div class="sanpham">
										...
										<div style="min-height: 44px;">
											<a class="aa" id="pName" href="detail?id=<?php echo $post->id ?>"><?php echo $post->products_name ?></a>
										</div>
											...
											<p>mã sản phẩm:<?php echo $post->id ?>, loại:<?php $a=$post->getcate();echo $a[0]->categaries_name ?>, </p>
											<p>
