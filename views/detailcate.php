		...
		<div class="s-body container">
			<div class="row">
				<div class="col-sm-12 col-md-9">
					<h1 class="h-title"> <?php foreach ($detailCate as $detailcate): ?>
		 <?php echo $detailcate->categaries_name ?>
	<?php endforeach ?> </h1>
			...
			<li id="<?php echo $cate->id ?>"><a href="detailcate?id=<?php echo $cate->id ?>" ><?php echo $cate->categaries_name ?></a></li>
		<?php endforeach ?>
					</ul>	
					<div class="tab-content">
						<div id="menu1" class="tab-pane fade in active">
							<div class="row">
							<?php foreach ($postdetailCate as $post): ?>
		...
		<?php include_once('views/auth/gio-hang.php'); ?>
		<script>
